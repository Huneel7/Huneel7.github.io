...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
      ...
      - { icon: fa-envelope, href: mailto:<sl4836@cumc.columbia.edu>, align: right }
...
rest_inspec %>% 
  ...
  layout(title = "Counts of Grades by Borough",
         xaxis = list(title = "Borough"),
...
rest_inspec %>%
  ...
  plot_ly(x = ~Date, y = ~count,
          color = ~violation_code, type = "scatter", mode = "lines", alpha = 0.5) 
...
```{r, echo = FALSE, message = FALSE}
  ...
  mutate(violation_code = recode(violation_code,"04L" = "Evidence of mice or live mice", 
 ...
 plot_ly(height = 240, 
  ...
  layout(title =  "Top 12 Worst Cuisines with Mice-related Violations",
